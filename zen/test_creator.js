...
{
    name: "2. zen.createNew(..., ...) passes an argument to the constructor",
    runTest: function() {
	var Person = function(name) {
	    this.name = name;
	};
	var person = zen.createNew(Person, "Paul");
	doh.assertEqual("Paul", person.name, "The argument 'Paul' should have been passed to the Person constructor");
    }
},
{
    name: "3. createNew(dijit.TitlePane, { id:'tp1', title:'Creator test 2' }) creates a TitlePane with id and title",
    setUp: function() {
    },
    runTest: function() {
