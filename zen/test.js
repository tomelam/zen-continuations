 ...
 var tree10 =
	...
	["dijit.layout.ContentPane",
	 ...
	 [["DIV", {style:{width:"100%",height:"140px",backgroundColor:"red"}},
	   []]]]]]]];
var tree11 =
    ["IFRAME", {id:"iframe", src:"doc/javascript.html", width:"100%", height:"400px"},
     []];
var tree12 =
    ["DIV", {id:"workingNode12"},
     [["dijit.layout.AccordionContainer",
...
test = function(tree) {
    ...
    */
    ...
    host = ""; //FIXME: This shouldn't be necessary!!!
    newComponent = zen.renderTreeDeferred(tree, zen.zenDiv, deferred);
    //newComponent = zen.renderTree(tree, zen.zenDiv);
